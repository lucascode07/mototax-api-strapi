...
export interface ApiDriverLicenseDriverLicense extends Schema.CollectionType {
  collectionName: 'driver_licenses';
  info: {
...
export interface ApiPilotPilot extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::driver-license.driver-license': ApiDriverLicenseDriverLicense;
      'api::pilot.pilot': ApiPilotPilot;
